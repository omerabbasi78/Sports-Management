...
namespace Repository.Pattern.Ef6
{
    public class UnitOfWork : IUnitOfWorkAsync
    {
        ...
        public Result<int> SaveChanges()
        {
            ...
            try
            {
                result.data = _dataContext.SaveChanges();
                result.success = true;
            }
            catch (Exception ex)
            {
                ...
                if (ex.InnerException is System.Data.Entity.Validation.DbEntityValidationException)
                    result.errors = (((ex as System.Data.Entity.Validation.DbEntityValidationException).EntityValidationErrors as List<System.Data.Entity.Validation.DbEntityValidationResult>)[0].ValidationErrors as List<System.Data.Entity.Validation.DbValidationError>).Select(s => s.ErrorMessage).ToList();
                else
